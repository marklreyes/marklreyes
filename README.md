...
* **[Sales Dashboard](https://github.com/marklreyes/sales-dashboard-supabase):** React, Vite and Supabase essentials for a real-world sales dashboard that fetches, inserts, and updates data in real-time.
